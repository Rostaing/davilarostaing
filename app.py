...
col2.markdown(
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <a href="https://www.whatsapp.com/channel/0029VaCp5uI3mFXz6SlZbc3s" target="_blank">
            <button style="color: white; background-color: green; border: none; padding: 5px 10px; cursor: pointer;">WhatsApp</button>
        </a>
